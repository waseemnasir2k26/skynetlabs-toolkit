        ...
        <div className="card space-y-4">
          ...
          <div className="space-y-3">
            {form.deliverables.map((d, idx) => (
              <div
                key={d.id}
                className="flex items-start gap-3 bg-dark-700 rounded-lg p-4 animate-fade-in"
              >
                <span className="text-xs text-gray-500 font-mono mt-2.5 min-w-[20px]">
                  {idx + 1}.
                </span>
          ...
          <div className="flex items-center justify-end gap-6 pt-4 border-t border-dark-500">
            <div className="text-sm text-gray-400">
              Total Hours: <span className="font-semibold text-gray-200">{totalHours}</span>
            </div>
            <div className="text-sm text-gray-400">
              Total Value:{' '}
