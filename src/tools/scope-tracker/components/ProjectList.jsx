    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="text-center mb-10">
        <div className="inline-flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: 'var(--accent-soft)', border: '1px solid var(--accent)' }}>
        ...
        <h1 className="text-3xl font-bold" style={{ color: 'var(--text-heading)' }}>Scope Creep Tracker</h1>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          <button
            ...
            style={
              !showArchived
                ? { background: 'var(--accent-soft)', color: 'var(--accent)', border: '1px solid var(--accent)', borderColor: 'var(--accent)' }
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3">
                      <h3 className="text-lg font-semibold truncate" style={{ color: 'var(--text-heading)' }}>
                        {project.projectName}
                      </h3>
                      {project.archived && (
                        <span className="badge border" style={{ background: 'var(--bg-elevated)', color: 'var(--text-muted)', borderColor: 'var(--border)' }}>
                          Archived
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-6 mt-3">
                      ...
                      <div className="text-sm">
                        <span style={{ color: 'var(--text-muted)' }}>Additional: </span>
                  ...
                  <div className="flex flex-col items-center shrink-0">
                    ...
                    <div className="text-xs" style={{ color: 'var(--text-muted)' }}>creep</div>
                    {/* Mini bar */}
                    <div className="w-16 rounded-full h-1.5 mt-2" style={{ background: 'var(--bg-elevated)' }}>
                      <div
      ...
      <div className="text-center mt-12 pb-8">
        <div className="text-xs tracking-[0.2em] font-bold mb-0.5" style={{ color: 'var(--accent)' }}>
          SKYNET LABS
        </div>
